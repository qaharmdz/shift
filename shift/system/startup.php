...
define('DIR_IMAGE', PATH_PUBLIC . 'media/image' . DS);
...
if (is_file(DIR_SYSTEM . 'autoloader/classmap_psr4_lowercase.php')) {
    $psr4lower = require_once DIR_SYSTEM . 'autoloader/classmap_psr4_lowercase.php';
