...
if (is_file(DIR_SYSTEM . 'framework/autoload/classmap_psr4_lower.php')) {
    $psr4lower = require_once DIR_SYSTEM . 'framework/autoload/classmap_psr4_lower.php';
    $loader->addClassMap($psr4lower);
}

$loaderPsr4Lower = new Shift\System\Framework\Autoload\ClassLoader($loader, PATH_SHIFT);
