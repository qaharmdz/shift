...
$_['help_open']                    = 'Fill in your site\'s opening times.';
...
$_['help_currency_auto']           = 'Set your site to automatically update currencies daily.';
$_['help_limit_admin']             = 'Determines how many admin items are shown per page (orders, customers, etc).';
$_['help_product_count']           = 'Show the number of products inside the subcategories in the sitefront header category menu. Be warned, this will cause an extreme performance hit for sites with a lot of subcategories!';
...
$_['help_ftp_root']                = 'The installation directory; normally \'public_html/\'.';
...
$_['help_mail_alert_email']        = 'Any additional emails you want to receive the alert email, in addition to the main site email. (comma separated).';
...
$_['help_shared']                  = 'Try to share the session cookie between sites so the cart can be passed between different domains.';
...
$_['help_maintenance']             = 'Prevents customers from browsing your site. They will instead see a maintenance message. If logged in as admin, you will see the site as normal.';
