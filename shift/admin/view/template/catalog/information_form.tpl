...
<div id="content">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <ul class="nav nav-tabs" id="language">
                ...
                <li><a href="#language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="./../image/flags/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
  ...
  <script type="text/javascript" src="asset/script/summernote/summernote.js"></script>
  <link href="asset/script/summernote/summernote.css" rel="stylesheet" />
  <script type="text/javascript" src="asset/script/summernote/image_manager.js"></script>
