...
class Upload extends Mvc\Controller
{
    ...
    public function delete()
    {
        ...
        if ($this->request->has('post.selected') && $this->validateDelete()) {
            foreach ($this->request->get('post.selected') as $upload_id) {
                ...
                if ($upload_info && is_file(PATH_STORAGE . 'upload' . DS . $upload_info['filename'])) {
                    unlink(PATH_STORAGE . 'upload' . DS . $upload_info['filename']);
                }
    ...
    public function download()
    {
        ...
        if ($upload_info) {
            $file = PATH_STORAGE . 'upload' . DS . $upload_info['filename'];
