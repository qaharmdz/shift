    ...
    public function index()
    {
        ...
        if (!$this->request->has('query.module_id')) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->router->url('extension/module/slideshow', 'token=' . $this->session->get('token'))
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_title'),
                'href' => $this->router->url('extension/module/slideshow', 'token=' . $this->session->get('token') . '&module_id=' . $this->request->get('query.module_id'))
            );
        }

        if (!$this->request->has('query.module_id')) {
            $data['action'] = $this->router->url('extension/module/slideshow', 'token=' . $this->session->get('token'));
        } else {
            $data['action'] = $this->router->url('extension/module/slideshow', 'token=' . $this->session->get('token') . '&module_id=' . $this->request->get('query.module_id'));
        }
