...
class ControllerDesignLanguage extends Controller
{
    ...
    public function path()
    {
        ...
        if ($language_info && (substr(str_replace('\\', DS, realpath(DIR_CATALOG . 'language/' . $language_info['code'] . '/' . $path)), 0, strlen(DIR_CATALOG . 'language')) == DIR_CATALOG . 'language')) {
            $path_data = array();
    ...
    public function translation()
    {
        ...
        if ($language_info && is_file($directory . $language_info['code'] . '/' . $path . '.php') && (substr(str_replace('\\', DS, realpath($directory . $language_info['code'] . '/' . $path . '.php')), 0, strlen(DIR_CATALOG . 'language')) == DIR_CATALOG . 'language')) {
