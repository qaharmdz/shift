...
class User extends Mvc\Controller
{
    ...
    protected function getList()
    {
        ...
        $data['results'] = sprintf($this->language->get('text_pagination'), ($user_total) ? (($page - 1) * $this->config->get('system.setting.limit_admin')) + 1 : 0, ((($page - 1) * $this->config->get('system.setting.limit_admin')) > ($user_total - $this->config->get('system.setting.limit_admin'))) ? $user_total : ((($page - 1) * $this->config->get('system.setting.limit_admin')) + $this->config->get('system.setting.limit_admin')), $user_total, ceil($user_total / $this->config->get('system.setting.limit_admin')));
