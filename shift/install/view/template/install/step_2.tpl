...
<div class="container">
  <header>
    <div class="row">
      ...
      <div class="col-sm-6">
        <div id="logo" class="pull-right hidden-xs"><img src="asset/image/logo.png" alt="Shift" title="Shift" /></div>
      </div>
    </div>
  </header>
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td>8.1+</td>
                <td class="text-center"><?php if (version_compare(PHP_VERSION, '7.4.0', '>=')) { ?>
