...
INSERT INTO `{DB_PREFIX}extension` (`extension_id`, `codename`, `type`, `name`, `version`, `description`, `author`, `url`, `setting`, `status`, `install`, `created`, `updated`) VALUES
	...
	(35, 'en', 'language', 'English', '1.0.0', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi quos a, quia rerum voluptates atque nulla nam accusantium nobis debitis. Voluptatibus natus et. Temporibus veniam, ea aspernatur iste enim, aperiam.\r\n', '', '', '{"flag":"en.png", "locale":"en-US,en_US.UTF-8,en_US,en-gb,english"}', 1, 1, NULL, NULL),
	(36, 'id', 'language', 'Indonesian', '1.0.0', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi quos a, quia rerum voluptates atque nulla nam accusantium nobis debitis. Voluptatibus natus et. Temporibus veniam, ea aspernatur iste enim, aperiam.\r\n', '', '', '{"flag":"id.png", "locale":"ID, en-ID,en_ID.UTF-8,indonesia"}', 1, 1, NULL, NULL),
...
INSERT INTO `{DB_PREFIX}route_alias` (`route_alias_id`, `site_id`, `language_id`, `route`, `param`, `value`, `alias`) VALUES
	...
	(617, 0, 1, 'content/tag', 'tag_id', '27', 'abcd-1'),
	(618, 0, 2, 'content/tag', 'tag_id', '27', 'abcd-2'),
	(619, 1, 1, 'content/tag', 'tag_id', '27', 'abcd-1'),
	(620, 1, 2, 'content/tag', 'tag_id', '27', 'abcd-2'),
	(629, 0, 1, 'content/post', 'post_id', '1', 'test-en-cool'),
	(630, 0, 2, 'content/post', 'post_id', '1', 'test-id'),
	(631, 1, 1, 'content/post', 'post_id', '1', 'test-en-cool'),
	(632, 1, 2, 'content/post', 'post_id', '1', 'test-id');
...
INSERT INTO `{DB_PREFIX}user` (`user_id`, `user_group_id`, `email`, `password`, `username`, `firstname`, `lastname`, `status`, `last_login`, `created`, `updated`) VALUES
	(1, 1, 'admin@example.com', '$2y$10$IPGfqRK9mgkp/QCJenkY5uSvhWpdzpLmIDTeHMTNGehvGfEqTnMXS', 'admin', 'John', 'Doe', 1, '2023-08-11 15:06:43', '2022-01-30 16:17:31', '2023-07-27 14:26:11'),
