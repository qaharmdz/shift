...
INSERT INTO `{DB_PREFIX}event` (`event_id`, `codename`, `description`, `emitter`, `listener`, `priority`, `status`) VALUES
	...
	(2, 'codex', '', 'admin/page/dashboard::after', 'extension/module/myMethod', 2, 1);
...
CREATE TABLE IF NOT EXISTS `{DB_PREFIX}extension` (
  ...
  UNIQUE KEY `type_codename` (`type`,`codename`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

INSERT INTO `{DB_PREFIX}extension` (`extension_id`, `type`, `codename`, `name`, `version`, `description`, `author`, `url`, `setting`, `status`, `install`, `created`, `updated`) VALUES
	(31, 'plugin', 'codex', 'Codex - HTML, Twig and Script', '1.0.0', 'Plugin Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi quos a, quia rerum voluptates atque nulla nam accusantium nobis debitis. ', 'Shift CMS', 'https://github.com/qaharmdz/shift', '[]', 1, 1, NOW(), NOW()),
	(32, 'theme', 'base', 'Theme Base', '1.0.0', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. ', 'Shift CMS', 'https://example.com', '[]', 1, 1, NOW(), NOW()),
	(33, 'plugin', 'architect', 'Architect', '0.1.0', '', 'Shift CMS', 'https://github.com/qaharmdz/shift', '[]', 1, 1, NOW(), NOW()),
	(35, 'language', 'en', 'English', '1.0.0', '', 'Shift CMS', 'https://github.com/qaharmdz/shift', '{"locale":"en-US,en_US.UTF-8,en_US,en-gb,english","flag":"en.png"}', 1, 1, NOW(), NOW()),
	(36, 'language', 'id', 'Indonesia', '1.0.0', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi quos a, quia rerum voluptates atque nulla nam accusantium nobis debitis. Voluptatibus natus et. Temporibus veniam, ea aspernatur iste enim, aperiam.\r\n', 'Shift CMS', 'https://github.com/qaharmdz/shift', '{"locale":"ID,en-ID,en_ID.UTF-8,indonesia","flag":"id.png"}', 1, 1, NOW(), NOW()),
	(37, 'module', 'codex', 'Codex - HTML, Twig and Script', '1.0.0', 'Module Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi quos a, quia rerum voluptates atque nulla nam accusantium nobis debitis. ', 'Shift CMS', 'https://github.com/qaharmdz/shift', '[]', 1, 1, NOW(), NOW());
...
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci COMMENT='TODO: remove';
...
INSERT INTO `{DB_PREFIX}post` (`post_id`, `parent_id`, `taxonomy`, `user_id`, `term_id`, `visibility`, `sort_order`, `status`, `created`, `updated`, `publish`, `unpublish`) VALUES
	...
	(2, 0, 'content_post', 1, 17, 'public', 0, 'publish', NOW(), NOW(), NOW(), NOW()),
	...
	(6, 0, 'content_post', 1, 18, 'public', 0, 'publish', NOW(), NOW(), NOW(), NULL),
	...
	(10, 0, 'content_post', 1, 1, 'public', 0, 'publish', NOW(), NOW(), NOW(), NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=1138 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
INSERT INTO `{DB_PREFIX}post_meta` (`post_meta_id`, `post_id`, `key`, `value`, `encoded`) VALUES
	...
	(1132, 10, 'visibility_usergroups', '[]', 1),
	(1133, 10, 'visibility_password', '', 0),
	(1134, 10, 'image', 'image/no-image.png', 0),
	(1135, 10, 'robots', '', 0),
	(1136, 10, 'comment', '', 0),
	(1137, 10, 'custom_code', '', 0);
...
INSERT INTO `{DB_PREFIX}route_alias` (`route_alias_id`, `site_id`, `language_id`, `route`, `param`, `value`, `alias`) VALUES
	...
	(1170, 0, 35, 'content/post', 'post_id', '10', 'about-us'),
	(1171, 0, 36, 'content/post', 'post_id', '10', 'about-us-36');
...
) ENGINE=InnoDB AUTO_INCREMENT=4196 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
INSERT INTO `{DB_PREFIX}setting` (`setting_id`, `site_id`, `group`, `code`, `key`, `value`, `encoded`) VALUES
	...
	(4029, 1, 'plugin', 'content', 'post_robots', 'index, follow', 0),
	(4030, 1, 'plugin', 'content', 'post_comment', 'register', 0),
	(4031, 1, 'plugin', 'content', 'post_custom_code', '', 0),
	(4032, 1, 'plugin', 'content', 'category_robots', 'index, follow', 0),
	(4033, 1, 'plugin', 'content', 'category_post_per_page', '10', 0),
	(4034, 1, 'plugin', 'content', 'category_post_lead', '1', 0),
	(4035, 1, 'plugin', 'content', 'category_post_lead_excerpt', '200', 0),
	(4036, 1, 'plugin', 'content', 'category_post_column', '2', 0),
	(4037, 1, 'plugin', 'content', 'category_post_column_excerpt', '100', 0),
	(4038, 1, 'plugin', 'content', 'category_post_order', 'p.publish~desc', 0),
	(4039, 1, 'plugin', 'content', 'category_custom_code', '', 0),
	(4040, 0, 'plugin', 'content', 'post_robots', 'index, nofollow', 0),
	(4041, 0, 'plugin', 'content', 'post_comment', 'register', 0),
	(4042, 0, 'plugin', 'content', 'post_custom_code', '', 0),
	(4043, 0, 'plugin', 'content', 'category_robots', 'index, follow', 0),
	(4044, 0, 'plugin', 'content', 'category_post_per_page', '10', 0),
	(4045, 0, 'plugin', 'content', 'category_post_lead', '1', 0),
	(4046, 0, 'plugin', 'content', 'category_post_lead_excerpt', '200', 0),
	(4047, 0, 'plugin', 'content', 'category_post_column', '2', 0),
	(4048, 0, 'plugin', 'content', 'category_post_column_excerpt', '48', 0),
	(4049, 0, 'plugin', 'content', 'category_post_order', 'p.publish~desc', 0),
	(4050, 0, 'plugin', 'content', 'category_custom_code', '', 0),
	(4136, 0, 'system', 'site', 'email', 'shift@example.com', 0),
	(4137, 0, 'system', 'site', 'meta_title', '{"35":"1st Shift Site","36":"1st Shift Site"}', 1),
	(4138, 0, 'system', 'site', 'meta_description', '{"35":"","36":""}', 1),
	(4139, 0, 'system', 'site', 'meta_keyword', '{"35":"","36":""}', 1),
	(4140, 0, 'system', 'site', 'logo', 'image/logo.png', 0),
	(4141, 0, 'system', 'site', 'favicon', 'image/favicon.png', 0),
	(4142, 0, 'system', 'site', 'language', 'en', 0),
	(4143, 0, 'system', 'site', 'layout_id', '1', 0),
	(4144, 0, 'system', 'site', 'theme', 'base', 0),
	(4145, 0, 'system', 'site', 'maintenance', '0', 0),
	(4146, 1, 'system', 'site', 'email', 'admin@example.com', 0),
	(4147, 1, 'system', 'site', 'meta_title', '{"35":"2nd Site","36":"2nd Site"}', 1),
	(4148, 1, 'system', 'site', 'meta_description', '{"35":"2nd Site","36":"2nd Site"}', 1),
	(4149, 1, 'system', 'site', 'meta_keyword', '{"35":"2nd Site","36":"2nd Site"}', 1),
	(4150, 1, 'system', 'site', 'logo', 'image/logo.png', 0),
	(4151, 1, 'system', 'site', 'favicon', 'image/favicon.png', 0),
	(4152, 1, 'system', 'site', 'language', 'en', 0),
	(4153, 1, 'system', 'site', 'layout_id', '1', 0),
	(4154, 1, 'system', 'site', 'theme', 'base', 0),
	(4155, 1, 'system', 'site', 'maintenance', '0', 0),
	(4171, 1, 'theme', 'base', 'primary', '#222', 0),
	(4172, 1, 'theme', 'base', 'primary_contrast', '#fff', 0),
	(4173, 1, 'theme', 'base', 'secondary', '#222', 0),
	(4174, 1, 'theme', 'base', 'secondary_contrast', '#fff', 0),
	(4175, 1, 'theme', 'base', 'custom_code', 's', 0),
	(4176, 0, 'theme', 'base', 'primary', '#222', 0),
	(4177, 0, 'theme', 'base', 'primary_contrast', '#fff', 0),
	(4178, 0, 'theme', 'base', 'secondary', '#222', 0),
	(4179, 0, 'theme', 'base', 'secondary_contrast', '#fff', 0),
	(4180, 0, 'theme', 'base', 'custom_code', 'e1', 0),
	(4181, 0, 'system', 'setting', 'compression', '6', 0),
	(4182, 0, 'system', 'setting', 'admin_language', 'en', 0),
	(4183, 0, 'system', 'setting', 'mail_engine', 'mail', 0),
	(4184, 0, 'system', 'setting', 'smtp_host', '', 0),
	(4185, 0, 'system', 'setting', 'smtp_username', '', 0),
	(4186, 0, 'system', 'setting', 'smtp_password', '', 0),
	(4187, 0, 'system', 'setting', 'smtp_port', '25', 0),
	(4188, 0, 'system', 'setting', 'smtp_timeout', '300', 0),
	(4189, 0, 'system', 'setting', 'error_display', '1', 0),
	(4190, 0, 'system', 'setting', 'development', '1', 0),
	(4191, 0, 'system', 'setting', 'mail_smtp_hostname', '', 0),
	(4192, 0, 'system', 'setting', 'mail_smtp_username', '', 0),
	(4193, 0, 'system', 'setting', 'mail_smtp_password', '', 0),
	(4194, 0, 'system', 'setting', 'mail_smtp_port', '', 0),
	(4195, 0, 'system', 'setting', 'mail_smtp_timeout', '', 0);
...
INSERT INTO `{DB_PREFIX}user` (`user_id`, `user_group_id`, `email`, `password`, `username`, `firstname`, `lastname`, `status`, `last_login`, `created`, `updated`) VALUES
	(1, 1, 'admin@example.com', '$2y$10$G49ON9LxaxrGQi508idTZ.KN/nqgdHfR52jWf6whBl9pPBeY0i5Ja', 'admin', 'Johnn', 'Doe', 1, NOW(), NOW(), NOW()),
	(3, 2, 'james@example.com', '$2y$10$NeYYCLxL.tttyffQzKmliOazCa9vCnJx5EkSerZwvEXtCaCrtqRaC', 'james', 'James', 'Doe', 0, NOW(), NOW(), NOW()),
	(4, 2, 'jane@example.com', '$2y$10$NeYYCLxL.tttyffQzKmliOazCa9vCnJx5EkSerZwvEXtCaCrtqRaC', 'janedoe', 'Jane', 'Doe', 0, NOW(), NOW(), NOW());
