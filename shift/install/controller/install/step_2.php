...
class ControllerInstallStep2 extends Controller
{
    ...
    public function index()
    {
        ...
        $data['requirements'] = array(
            'gd'       => boolVal(extension_loaded('gd')) ? 'Enabled' : 'Disabled',
            'xml'      => boolVal(extension_loaded('xml')) ? 'Enabled' : 'Disabled',
            'json'     => boolVal(extension_loaded('json')) ? 'Enabled' : 'Disabled',
            'zip'      => boolVal(extension_loaded('zip')) ? 'Enabled' : 'Disabled',
            'zlib'     => boolVal(extension_loaded('zlib')) ? 'Enabled' : 'Disabled',
            'iconv'    => boolVal(function_exists('iconv')) ? 'Enabled' : 'Disabled',
            'mbstring' => boolVal(extension_loaded('mbstring')) ? 'Enabled' : 'Disabled',
            'curl'     => boolVal(extension_loaded('curl')) ? 'Enabled' : 'Disabled',
        );
        ...
        $data['config_catalog'] = PATH_SHIFT . 'config.php';
        $data['config_admin'] = PATH_SHIFT . 'admin/config.php';
